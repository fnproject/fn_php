...
class AppsApi
{
     ...
     */
    public function appsGet($cursor = null, $per_page = null)
    {
        list($response) = $this->appsGetWithHttpInfo($cursor, $per_page);
        return $response;
    }
     ...
     */
    public function appsGetWithHttpInfo($cursor = null, $per_page = null)
    {
        // parse inputs
        $resourcePath = "/apps";
        $httpBody = '';
