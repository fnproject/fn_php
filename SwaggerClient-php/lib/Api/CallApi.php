...
class CallApi
{
     ...
     *
     * @param string $app App name. (required)
     * @param string $path Route path to match, exact. (optional)
     ...
     * @param int $from_time Unix timestamp in seconds, of call.created_at to begin the results at, default 0. (optional)
     * @param int $to_time Unix timestamp in seconds, of call.created_at to end the results at, defaults to latest. (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\CallsWrapper
     */
    public function appsAppCallsGet($app, $path = null, $cursor = null, $per_page = null, $from_time = null, $to_time = null)
    {
        list($response) = $this->appsAppCallsGetWithHttpInfo($app, $path, $cursor, $per_page, $from_time, $to_time);
        return $response;
    }
     ...
     */
    public function appsAppCallsGetWithHttpInfo($app, $path = null, $cursor = null, $per_page = null, $from_time = null, $to_time = null)
    {
        // verify the required parameter 'app' is set
        if ($app === null) {
        ...
        // query params
        if ($from_time !== null) {
            $queryParams['from_time'] = $this->apiClient->getSerializer()->toQueryValue($from_time);
        }
        // query params
        if ($to_time !== null) {
            $queryParams['to_time'] = $this->apiClient->getSerializer()->toQueryValue($to_time);
        }
        // path params
        if ($app !== null) {
            $resourcePath = str_replace(
